...
module.exports.handleEvent = async function({ event, api, Users }) {
  ...
  const botKeywords = [
    ...
    "ফাহিম বস তোমাকে ভালোবাসে😌",
    "বলো জানু 🌚",
    "তোর কি চোখে পড়ে না আমি ফাহিম জানুর সাথে ব্যাস্ত আছি😒",
    "আসসালামু আলাইকুম বলেন আপনার জন্য কি করতে পারি",
    "🌻🌺💚আসসালামু আলাইকুম ওয়া রাহমাতুল্লাহ",
    "আমি এখন বস ফাহিম এর সাথে বিজি আছি আমাকে ডাকবেন না",
    "আজকে আমার মন ভালো নেই তাই আমারে ডাকবেন না",
    "চুনা ও চুনা আমার বস ফাহিম এর হবু বউ রে কেও দেকছো",
    "ইসস এতো ডাকো কেনো লজ্জা লাগে তো",
    "আমার বস ফাহিম এর পক্ষ থেকে তোমারে এতো এতো ভালোবাসা",
    "হাজারো লুচ্চা লুচ্চির ভিরে",
    "রূপের অহংকার করো না",
    "এত অহংকার করে লাভ নেই",
    "দিন দিন কিছু মানুষের কাছে অপ্রিয় হয়ে যাইতেছি",
    "দুনিয়ার সবাই প্রেম করে.!🤧 -আর মানুষ আমার বস ফাহিম কে সন্দেহ করে",
    ...
    "৯৯টাকায় ৯৯জিবি ৯৯বছর-☺️🐸 -অফারটি পেতে এখনই ফাহিম কে প্রোপস করুন",
  ...
  if (isBotMessage) {
    ...
    const replyMessage = {
      body: `${userName}\n🤬তুই আবাল বট এরজন্য ব্যান করে দিলাম \n•Type /ban list`
    };
